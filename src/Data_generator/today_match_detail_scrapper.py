# today_match_detail_scrapper.py
import requests
...
def extract_match_details(match_url):
    ...
    if not team1_players or not team2_players:
        print(f"❌ No players found for {match_date}!")
        return match_date, []
    ...
    if "won the toss" in toss_info:
        ...
        print(f"⚠️ Toss info not found. Defaulting innings.")
...
def main():
    ...
    for match_url in match_urls:
        ...
        if match_data and match_date.lower() == user_date.lower():
            ...
            save_to_csv(match_data, filename="today_match_details.csv")
            print("✅ CSV file saved: match_players.csv")
            return
